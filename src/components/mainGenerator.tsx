    ...
    <>
      <div className="sm:w-full md:w-[40rem]">
        <div className="py-9 sm:px-5 md:px-24 mx-4 rounded-xl flex flex-col items-center justify-center bg-base-200 border-b-2 border-secondary">
          ...
          <p className="tt-color mb-6 font-semibold text-secondary">Phone Number Generator</p>
          ...
          {/* ------ BUTTON GENERATE ------ */}
          <button onClick={() => generateNumber()} disabled={totalNum == "0" || totalNum == "" ? true : false} className="btn btn-secondary w-full bottom-btn">
